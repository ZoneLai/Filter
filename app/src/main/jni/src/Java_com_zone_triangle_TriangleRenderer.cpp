...
JNIEXPORT void JNICALL Java_com_zone_triangle_TriangleRenderer_nativeSetFilter(JNIEnv *env, jobject thiz, jint filterMode)
{
	TriangleManager::getSingleton().setFilterMode((TriangleManager::FILTER)filterMode);
}
